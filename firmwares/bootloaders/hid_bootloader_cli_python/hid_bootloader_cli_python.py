...
def get_hid_device_handle():
    ...
    if len(valid_hid_devices) is 0:
        hid_device_filter = hid.HidDeviceFilter(vendor_id=0x6969, product_id=0x9693)
        valid_hid_devices = hid_device_filter.get_devices()
        
    if len(valid_hid_devices) is 0:
        hid_device_filter = hid.HidDeviceFilter(vendor_id=0x6969, product_id=0x9692)
        valid_hid_devices = hid_device_filter.get_devices()
